...
describe('Browser Manager', () => {
  ...
  // Note: Brave Path Detection tests removed - brave-real-launcher handles this automatically
  ...
  describe('Force Kill Brave Processes', () => {
    it('should execute without throwing errors', async () => {
      // Arrange & Act: Force kill Brave processes
      // Act & Assert: Should not throw error regardless of platform
      await expect(forceKillAllBraveProcesses()).resolves.toBeUndefined();
    });
