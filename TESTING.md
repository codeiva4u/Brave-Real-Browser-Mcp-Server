...
This document explains the restructured testing approach for the brave-real-browser MCP server, with clear separation of concerns and elimination of redundancy.
